...
onMounted(() => {
  watchEffect(() => {
    currentImage.value = "https://picsum.photos/id/37/800/800";
    images.value[0] = "https://picsum.photos/id/37/800/800";
  });
});
...
const priceComputed = computed(() => {
  return "26.40"; // TODO make it dynamic
});

const images = ref([
  "",
  "https://picsum.photos/id/267/800/800",
  "https://picsum.photos/id/123/800/800",
